...
To use the v2 version of `.pipeline-config.yaml` configuration file ([read more](/docs/devsecops?topic=devsecops-devsecops-pipeline-config-v2)), please follow the reference pipeline template, see [configuration for pull requests](https://us-south.git.cloud.ibm.com/open-toolchain/hello-compliance-app/-/blob/master/.pr-pipeline-config-v2.yaml){: external}, [continuous integration](https://us-south.git.cloud.ibm.com/open-toolchain/hello-compliance-app/-/blob/master/.ci-pipeline-config-v2.yaml){: external} and [configuration for continuous deployment](https://us-south.git.cloud.ibm.com/open-toolchain/hello-compliance-deployment/-/blob/master/pipeline-config-v2.yaml){: external}.
