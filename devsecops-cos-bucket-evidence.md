...
Refer to this [page](/docs/devsecops?topic=devsecops-cd-devsecops-advanced-pipelines-customization&q=Continuous+Deployment+&tags=devsecops#cos-bucket-considerations) for more information about considerations (granularity, security, ...) for using Cloud {{site.data.keyword.cos_short}} for compliance evidence.
{: note}
