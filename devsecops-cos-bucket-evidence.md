...
The compliance automation pipeline stores the following information in your [evidence locker](/docs/devsecops?topic=devsecops-devsecops-evidence#cd-devsecops-lockers-cos):
