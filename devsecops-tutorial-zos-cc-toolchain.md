...
{: #tutorial-zos-cc-toolchain}
{: toc-content-type="tutorial"}
{: toc-services="z/OS, containers, ContinuousDelivery"}
{: toc-completion-time="1h"}

This tutorial is part 4 of a 4-part tutorial series where you learn {{site.data.keyword.cloud}} DevSecOps best practices by using a complete reference implementation that is available as a service and powered by {{site.data.keyword.contdelivery_full}}. In part 4 of this tutorial series, you use the toolchain template to continuously scan your deployed z/OS code based on DevSecOps best practices and Continuous Compliance (CC).

{: shortdesc}

## Before you begin
{: #zos-cc-toolchain-prereqs}

Before you begin part 4 of this tutorial series, ensure that you completed the following prerequisites:
1. Complete [Part 1: Set up prerequisites](/docs/devsecops?topic=devsecops-tutorial-zos-prereqs).
1. Complete [Part 2: Set up a Continuous Integration (CI) toolchain for z/OS](/docs/devsecops?topic=devsecops-tutorial-zos-ci-toolchain).
1. Complete [Part 3: Set up a Continuous Deployment (CD) toolchain for z/OS](/docs/devsecops?topic=devsecops-tutorial-zos-cd-toolchain).
...
* From the {{site.data.keyword.cloud_notm}} console, click **Menu** ![Menu icon](../icons/icon_hamburger.svg) and select **DevOps**. On the **Toolchains** page, click **Create toolchain**. On the Create a Toolchain page, click **CC - Keep your z/OS app Continuously Compliant with DevSecOps practices**.

## Set up the CC toolchain name and region
{: #zos-cc-toolchain-name-region}
{: step}
...
![DevSecOps CC toolchain welcome page](images/devsecops-zos-cc-welcome-page.png){: caption="Figure 1. DevSecOps CC toolchain welcome page" caption-side="bottom"}
...
{: #zos-cc-toolchain-tool-integrations}
{: step}

### Secrets
{: #zos-cc-toolchain-secrets}
...
1. Select the IBM Cloud API key that you created and used during your CI toolchain setup. Optionally, you can create a new key and store it in your preferred choice of secrets vault.
1. Enter the environment tag in your inventory. It is the tag in your Inventory repository that reflects the state of your current deployed environment. This tag is the snapshot of current running application on target.
1. Choose a region, and select an available Virtual Private Cloud from the dropdown list.
1. Select a z/OS virtual server instance from the list.
1. Enter the target z/OS SSH port and the z/OS user ID.
1. Enter the z/OS SSH secret name that is declared in your secret manager.
1. Optionally, you can enter the DBB Web Application URL. If you do not provide the URL, a full build will be done. If the DBB WebApp URL is provided, an impact build will be done.
...
{: #zos-cc-toolchain-tekton-pipeline}
...
### Evidence Storage
{: #zos-cc-toolchain-evidence-storage}
...
### Optional tools
{: #zos-cc-toolchain-optional-tools}

#### Slack
{: #zos-cc-toolchain-slack}
...
{: #zos-cc-toolchain-private-worker}
...
### Incident issues
{: #zos-cc-toolchain-incident-issues}
...
{: #zos-cc-toolchain-insights-explore}
