...
{: #zos-cd-toolchain-tekton-pipeline}
...
{: #zos-cd-toolchain-create-options}
{: step}
...
* From the {{site.data.keyword.cloud_notm}} console, click **Menu** ![Menu icon](../icons/icon_hamburger.svg) and select **DevOps**. On the Toolchains page, click **Create toolchain**. On the Create a Toolchain page, click **CD - Deploy a secure z/OS app with DevSecOps practices**.

## Set up the CD toolchain name and region
{: #zos-cd-toolchain-name-region}
{: step}
...
### Evidence Storage
{: #zos-cd-toolchain-evidence-storage}
...
{: #zos-cd-toolchain-single-cluster-target}
...
{: #zos-cd-toolchain-multiple-clusters-target}
...
### Custom target
{: #zos-cd-toolchain-custom-target}
...
{: #zos-cd-toolchain-change-request}
...
### Optional Tools
{: #zos-cd-toolchain-optional-tools}

#### Slack
{: #zos-cd-toolchain-slack}
